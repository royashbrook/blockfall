...
impl<'c> World<'c> {
    ...
    fn debris_color(b: BlockId) -> V3 {
        match b {
            ...
            57 => V3::new(0.46, 0.48, 0.45),      // shaped mixed stone rubble
            58 => V3::new(0.48, 0.49, 0.50),      // mason bench: dressed stone
            59 => V3::new(0.38, 0.36, 0.34),      // forge: soot-dark masonry
            60 => V3::new(0.48, 0.43, 0.24),      // herbalist table: wood and herbs
            61 => V3::new(0.58, 0.39, 0.20),      // sawbench: fresh timber
            62 => V3::new(0.60, 0.42, 0.22),      // communal bench: warm oak
            63 => V3::new(0.66, 0.51, 0.25),      // broom rack: wood and straw
